    ...
    clusters.forEach((feature) => {
      ...
      if (isCluster(feature)) {
        ...
        if (props.kind === 'need') {
          ...
          const needHandSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 11V5a1.5 1.5 0 0 1 3 0v5"/><path d="M10 9.5V3.5a1.5 1.5 0 0 1 3 0V9.5"/><path d="M13 9.5V4.5a1.5 1.5 0 0 1 3 0V10"/><path d="M16 11V7a1.5 1.5 0 0 1 3 0v7a7 7 0 0 1-7 7h-1a7 7 0 0 1-6.5-4.4L3 12.5a1.5 1.5 0 0 1 2.5-1.6L7 13"/></svg>`;
