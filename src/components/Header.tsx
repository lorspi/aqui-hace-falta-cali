          ...
          {isLoggedIn ? (
            ...
            <>
              <button
                ...
                className="w-full text-left px-3.5 py-2.5 text-xs sm:text-sm text-slate-400 bg-slate-50 flex items-center gap-2.5 transition-colors cursor-not-allowed border-b border-slate-100 font-semibold opacity-60"
              >
