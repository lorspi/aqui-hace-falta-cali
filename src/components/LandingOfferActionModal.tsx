    ...
    >
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-7 shadow-2xl border border-slate-200 relative text-left my-auto animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        <div className="mt-5 space-y-1.5 relative z-10 text-center">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 border border-blue-200/80 text-brand-blue text-xs font-bold mb-1 font-sans">
            <HeartHandshake className="w-3.5 h-3.5" />
            <span>Canalizar ayuda</span>
          </div>
        ...
        {/* Footer info / dismiss */}
        <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 relative z-10">
          <span className="text-[11px] text-slate-500 font-body">
            Filtro inteligente raDAR
          </span>
          <button
            type="button"
            onClick={onClose}
            className="text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors cursor-pointer py-1 px-2 rounded-lg hover:bg-slate-100 font-sans"
          >
            Ir al mapa general
          </button>
        </div>
