...
const Pedir: React.FC = () => {
  ...
  if (e.publicado) {
    pantalla = <ExitoFlujo tipo="pedir" extra={<Coincidencias publicacion={publicacionDe(e, metas)} />} abre={PUERTAS.pedir.abre} onPanel={() => irA(`${RUTAS.miOrganizacion}#necesidades`)} onCerrar={irMapa} />;
