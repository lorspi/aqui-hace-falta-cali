...
export const RadarAnimatedLogo: React.FC<RadarAnimatedLogoProps> = ({ onOpenChat, className = '' }) => {
  return (
    <div className={`relative w-full aspect-square mx-auto flex items-center justify-center ${className}`}>
      ...
      <svg
        viewBox="100.823 3.77 1024 1024"
        className="w-full h-full drop-shadow-sm select-none overflow-visible"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* 1. ONDAS DE RADAR LIBRES: Luminosas, ganan fuerza y resplandor al expandirse */}
        <g className="pointer-events-none">
          <circle
            ...
            className="animate-svg-ripple-1"
          ...
          <circle
            ...
            strokeWidth="1.8"
            vectorEffect="non-scaling-stroke"
            className="animate-svg-ripple-2"
            style={{ transformOrigin: '612.823px 515.77px' }}
          />
          <circle
            cx="612.823"
            ...
            strokeWidth="1.8"
            vectorEffect="non-scaling-stroke"
            className="animate-svg-ripple-3"
            style={{ transformOrigin: '612.823px 515.77px' }}
          />
        </g>
        ...
        <g clipPath="url(#clip0_huge_radar_bulletproof)">
          ...
          {/* Capa Azul Oficial - Arco Interior */}
          <path
          ...
          {/* 3. EL CENTRO ROJO NATIVO: EN EL TOPE SUPERIOR */}
          <g
            role="button"
            tabIndex={0}
            onClick={onOpenChat}
        ...
        <defs>
          <clipPath id="clip0_huge_radar_bulletproof">
