      ...
      {onSubmitForm && (
        <div className="pt-2 space-y-3">
          ...
          <button
            ...
            className="w-full py-3 px-6 bg-slate-100 border border-slate-200 text-slate-400 font-bold text-xs sm:text-sm rounded-xl shadow-xs flex items-center justify-center gap-2.5 transition-all cursor-not-allowed opacity-60"
          >
