/**
 * Pre-seeded realistic DEMO DATA for Cali, Colombia.
 * Earthquake Emergency - August 10, 2026.
 * Note: Clearly tagged as DEMO DATA for testing and simulation purposes.
 */

import { City, Emergency, Need } from '../types';
...
export const DEMO_EMERGENCY: Emergency = {
  id: 'terremoto-cali-2026',
  name: 'Terremoto Colombia — Agosto 2026',
  type: 'Terremoto / Sismo',
  description: 'Sismo registrado el 10 de agosto de 2026 con afectaciones estructurales en varios sectores de Cali.',
  startDate: '2026-08-10T14:30:00Z',
  status: 'ACTIVE',
};

export const INITIAL_DEMO_NEEDS: Need[] = [
  {
    id: 'need-001',
    cityId: 'cali',
    emergencyId: 'terremoto-cali-2026',
    title: 'Edificio Residencial Las Acacias — Colapso Parcial de Muro',
    description: 'Se requieren voluntarios capacitados y herramientas de mano para la remoción segura de escombros en el acceso principal y clasificación de enseres. Acceso libre para vehículos de carga liviana.',
  ...
  },
  {
    ...
    description: 'Punto oficial de recepción de donaciones y empaque de kits alimentarios. Se necesitan con urgencia personas para clasificar ropa, empacar alimentos no perecederos y agua potable.',
  ...
  },
  {
    ...
    description: 'Se requieren donantes de sangre de todos los grupos sanguíneos, en especial O negativo y A positivo, para la atención de heridos remitidos por el evento sísmico.',
  ...
  },
  {
    ...
    description: 'Varias familias sufrieron agrietamiento severo en viviendas de ladera. Se requieren plásticos de gran calibre, madera para apuntalamiento temporal, alimentos preparados y kits de aseo.',
  ...
  },
  {
    ...
    description: 'Campamento temporal habilitado para familias evacuadas de zonas de riesgo. Necesitan colchones inflables, cobijas, pañales para bebé y alimentos para mascotas.',
    placeType: 'REFUGIO',
  ...
  },
  {
    ...
    description: 'Se requieren camionetas tipo estacas o furgones pequeños para transportar agua y cajas de kits desde el centro de acopio hacia comunas del oriente (Comuna 7 y Comuna 14).',
  ...
  },
  {
    ...
    description: 'Clínica veterinaria solidaria atendiendo mascotas heridas o desorientadas durante las evacuaciones. Se necesitan medicamentos de curación, sueros veterinarios y jaulas de transporte.',
  ...
  },
  {
    ...
    description: 'Afectación vial y paso restringido. Requieren personas con botas de seguridad y palas para apoyar despeje de tierra en paso peatonal de acceso al barrio.',
    placeType: 'COMUNIDAD_AFECTADA',
