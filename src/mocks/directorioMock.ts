...
export const ENTIDADES: Entidad[] = [
  ...
  { id: 'jac-el-recuerdo', nombre: 'JAC El Recuerdo', tipo: 'Junta de acción comunal', clase: 'comunidad', verificada: false, zona: 'Bosa', lat: 4.615, lng: -74.196, dir: 'Cl. 59 sur #97-22', tel: '+57 313 555 1140', wa: true, lider: 'Camilo Estévez · Presidente JAC', familias: 28, entregas: 0 },
  ...
  { id: 'jac-vereda-el-destino', nombre: 'JAC Vereda El Destino', tipo: 'Junta de acción comunal', clase: 'comunidad', verificada: false, zona: 'Usme rural', lat: 4.499, lng: -74.13, dir: 'Vereda El Destino, km 12 vía Usme', tel: '+57 315 555 6012', wa: true, lider: 'Alonso Neuta · Presidente JAC', familias: 42, entregas: 0 },
  { id: 'colegio-rafael-uribe', nombre: 'Colegio Rafael Uribe Uribe', tipo: 'Colegio · albergue temporal', clase: 'comunidad', verificada: true, zona: 'Rafael Uribe Uribe', lat: 4.571, lng: -74.118, dir: 'Cl. 32 sur #23-20', tel: '+57 601 555 2190', wa: true, lider: 'Rectoría · Comité de acogida', personas: 220, entregas: 0 },
  ...
  { id: 'jac-potrero-grande', nombre: 'JAC Potrero Grande', tipo: 'Junta de acción comunal', clase: 'comunidad', verificada: false, ciudad: 'cali', zona: 'Potrero Grande', lat: 3.418, lng: -76.478, dir: 'Cra. 28E #121-30', tel: '+57 316 555 4470', wa: true, lider: 'Rosa Angulo · Presidenta JAC', familias: 96, entregas: 0 },
