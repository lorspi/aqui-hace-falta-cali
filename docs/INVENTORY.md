...
- `flujos/PedirPage` — ruta `/pedir-v2`: pedir ayuda, una pregunta por pantalla (emergencia, qué hace falta, días, cuántas personas / viviendas / animales, cantidades a mano, dónde con mapa, contacto, fotos, revisar). Las metas salen de `utils/equivalencias.ts` y se ven cambiar mientras se responde.
